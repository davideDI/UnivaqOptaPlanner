...
public class Course extends AbstractPersistable {
	...
	public String toString() {
		return "Course [code=" + code + ", teacher=" + teacher + ", lectureSize=" + lectureSize + ", minWorkingDaySize="
				+ minWorkingDaySize + ", curriculumList=" + curriculumList + ", studentSize=" + studentSize + "]";
	}
