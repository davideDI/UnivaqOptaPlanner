...
public class CourseSchedule extends AbstractPersistable {
	...
	public String toString() {
		return "CourseSchedule [name=" + name + ", teacherList=" + teacherList + ", curriculumList=" + curriculumList
				+ ", courseList=" + courseList + ", dayList=" + dayList + ", timeslotList=" + timeslotList
				+ ", periodList=" + periodList + ", roomList=" + roomList + ", unavailablePeriodPenaltyList="
				+ unavailablePeriodPenaltyList + ", lectureList=" + lectureList + ", score=" + score + "]";
	}
